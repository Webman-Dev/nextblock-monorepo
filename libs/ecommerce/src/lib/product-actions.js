...
export async function getProducts(supabase, { page = 1, limit = 10, search = '' } = {}) {
...
export async function createProduct(supabase, data) {
...
export async function updateProduct(supabase, id, data) {
    const { media_id, ...rest } = data;
    const productData = {
        title: rest.title,
        slug: rest.slug,
