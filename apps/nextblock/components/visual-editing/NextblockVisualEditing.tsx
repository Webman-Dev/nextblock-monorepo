    ...
    <>
      ...
      {!isEditorOpen && (
        <div
          ...
          className="fixed bottom-4 left-1/2 z-[1000] flex -translate-x-1/2 items-center gap-2 rounded-md border border-border bg-background/95 px-3 py-2 text-sm shadow-lg backdrop-blur"
        >
          <span className="font-medium">Draft editing</span>
          {draftActions}
          {(message || isSavingBlock || isLoadingBlock) && (
