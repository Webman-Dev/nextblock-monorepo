...
DROP POLICY IF EXISTS "posts_authenticated_comprehensive_read" ON "public"."posts";
DROP POLICY IF EXISTS "posts_anon_can_read_published" ON "public"."posts";
DROP POLICY IF EXISTS "posts_admin_writer_can_update" ON "public"."posts";
DROP POLICY IF EXISTS "posts_admin_writer_can_insert" ON "public"."posts";
DROP POLICY IF EXISTS "posts_admin_writer_can_delete" ON "public"."posts";
...
DROP POLICY IF EXISTS "pages_authenticated_comprehensive_read" ON "public"."pages";
DROP POLICY IF EXISTS "pages_anon_can_read_published" ON "public"."pages";
DROP POLICY IF EXISTS "pages_admin_writer_can_update" ON "public"."pages";
DROP POLICY IF EXISTS "pages_admin_writer_can_insert" ON "public"."pages";
DROP POLICY IF EXISTS "pages_admin_writer_can_delete" ON "public"."pages";
...
DROP POLICY IF EXISTS "nav_items_authenticated_can_read" ON "public"."navigation_items";
DROP POLICY IF EXISTS "nav_items_anon_can_read" ON "public"."navigation_items";
DROP POLICY IF EXISTS "nav_items_admin_can_update" ON "public"."navigation_items";
DROP POLICY IF EXISTS "nav_items_admin_can_insert" ON "public"."navigation_items";
DROP POLICY IF EXISTS "nav_items_admin_can_delete" ON "public"."navigation_items";
DROP POLICY IF EXISTS "media_public_can_read" ON "public"."media";
...
DROP POLICY IF EXISTS "languages_are_publicly_readable_for_all_roles" ON "public"."languages";
DROP POLICY IF EXISTS "languages_admin_can_update" ON "public"."languages";
DROP POLICY IF EXISTS "languages_admin_can_insert" ON "public"."languages";
DROP POLICY IF EXISTS "languages_admin_can_delete" ON "public"."languages";
...
DROP POLICY IF EXISTS "Allow read access to all anonymous users" ON "public"."translations";
...
ALTER TABLE IF EXISTS ONLY "public"."posts" DROP CONSTRAINT IF EXISTS "posts_language_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."posts" DROP CONSTRAINT IF EXISTS "posts_author_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."post_revisions" DROP CONSTRAINT IF EXISTS "post_revisions_post_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."post_revisions" DROP CONSTRAINT IF EXISTS "post_revisions_author_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."pages" DROP CONSTRAINT IF EXISTS "pages_language_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."pages" DROP CONSTRAINT IF EXISTS "pages_author_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."page_revisions" DROP CONSTRAINT IF EXISTS "page_revisions_page_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."page_revisions" DROP CONSTRAINT IF EXISTS "page_revisions_author_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."navigation_items" DROP CONSTRAINT IF EXISTS "navigation_items_parent_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."navigation_items" DROP CONSTRAINT IF EXISTS "navigation_items_page_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."navigation_items" DROP CONSTRAINT IF EXISTS "navigation_items_language_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."media" DROP CONSTRAINT IF EXISTS "media_uploader_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."logos" DROP CONSTRAINT IF EXISTS "logos_media_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."posts" DROP CONSTRAINT IF EXISTS "fk_feature_image";
ALTER TABLE IF EXISTS ONLY "public"."blocks" DROP CONSTRAINT IF EXISTS "blocks_post_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."blocks" DROP CONSTRAINT IF EXISTS "blocks_page_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."blocks" DROP CONSTRAINT IF EXISTS "blocks_language_id_fkey";
...
DROP TRIGGER IF EXISTS "Next.js Revalidate Posts" ON "public"."posts";
DROP TRIGGER IF EXISTS "Next.js Revalidate Pages" ON "public"."pages";
...
DROP INDEX IF EXISTS "public"."idx_posts_translation_group_id";
DROP INDEX IF EXISTS "public"."idx_posts_feature_image_id";
DROP INDEX IF EXISTS "public"."idx_posts_author_id";
DROP INDEX IF EXISTS "public"."idx_post_revisions_post_id_version";
DROP INDEX IF EXISTS "public"."idx_post_revisions_post_id";
DROP INDEX IF EXISTS "public"."idx_pages_translation_group_id";
DROP INDEX IF EXISTS "public"."idx_pages_author_id";
DROP INDEX IF EXISTS "public"."idx_page_revisions_page_id_version";
DROP INDEX IF EXISTS "public"."idx_page_revisions_page_id";
DROP INDEX IF EXISTS "public"."idx_navigation_items_parent_id";
DROP INDEX IF EXISTS "public"."idx_navigation_items_page_id";
DROP INDEX IF EXISTS "public"."idx_navigation_items_menu_lang_order";
DROP INDEX IF EXISTS "public"."idx_navigation_items_language_id";
DROP INDEX IF EXISTS "public"."idx_media_uploader_id";
DROP INDEX IF EXISTS "public"."idx_blocks_post_id";
DROP INDEX IF EXISTS "public"."idx_blocks_page_id";
DROP INDEX IF EXISTS "public"."idx_blocks_language_id";
DROP INDEX IF EXISTS "public"."ensure_single_default_language_idx";
...
ALTER TABLE IF EXISTS ONLY "public"."posts" DROP CONSTRAINT IF EXISTS "posts_language_id_slug_key";
ALTER TABLE IF EXISTS ONLY "public"."post_revisions" DROP CONSTRAINT IF EXISTS "post_revisions_post_version_key";
ALTER TABLE IF EXISTS ONLY "public"."post_revisions" DROP CONSTRAINT IF EXISTS "post_revisions_pkey";
ALTER TABLE IF EXISTS ONLY "public"."pages" DROP CONSTRAINT IF EXISTS "pages_pkey";
ALTER TABLE IF EXISTS ONLY "public"."pages" DROP CONSTRAINT IF EXISTS "pages_language_id_slug_key";
ALTER TABLE IF EXISTS ONLY "public"."page_revisions" DROP CONSTRAINT IF EXISTS "page_revisions_pkey";
ALTER TABLE IF EXISTS ONLY "public"."page_revisions" DROP CONSTRAINT IF EXISTS "page_revisions_page_version_key";
...
ALTER TABLE IF EXISTS ONLY "public"."media" DROP CONSTRAINT IF EXISTS "media_object_key_key";
ALTER TABLE IF EXISTS ONLY "public"."logos" DROP CONSTRAINT IF EXISTS "logos_pkey";
...
DROP FUNCTION IF EXISTS "public"."handle_posts_update"();
DROP FUNCTION IF EXISTS "public"."handle_pages_update"();
DROP FUNCTION IF EXISTS "public"."handle_new_user"();
DROP FUNCTION IF EXISTS "public"."handle_navigation_items_update"();
DROP FUNCTION IF EXISTS "public"."handle_media_update"();
DROP FUNCTION IF EXISTS "public"."handle_languages_update"();
DROP FUNCTION IF EXISTS "public"."handle_blocks_update"();
...
DROP TYPE IF EXISTS "public"."revision_type";
DROP TYPE IF EXISTS "public"."page_status";
DROP TYPE IF EXISTS "public"."menu_location";
...
ALTER TYPE "public"."revision_type" OWNER TO "postgres";
...
--
-- Name: COLUMN "media"."folder"; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "page_revisions"; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN "page_revisions"."content"; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: page_revisions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN "pages"."version"; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "post_revisions"; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN "post_revisions"."content"; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: post_revisions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN "posts"."version"; Type: COMMENT; Schema: public; Owner: postgres
--
...
00000000-0000-0000-0000-000000000000	a563ec7c-aa26-494e-9ab9-e6a461216925	{"action":"token_refreshed","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025-10-01 17:12:39.056316+00	
00000000-0000-0000-0000-000000000000	fdd49ceb-2b8d-4d00-91c6-1ac70101092b	{"action":"token_revoked","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025-10-01 17:12:39.069494+00	
00000000-0000-0000-0000-000000000000	274b5b53-1bbb-4747-9783-5689c27671e4	{"action":"token_refreshed","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025-10-01 18:11:22.093704+00	
00000000-0000-0000-0000-000000000000	c30d52a1-ecf0-4074-8357-f687828e2fca	{"action":"token_revoked","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025-10-01 18:11:22.100742+00	
00000000-0000-0000-0000-000000000000	03e5365e-d4ce-4b63-9097-57187b656689	{"action":"token_refreshed","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025-10-01 19:12:00.189386+00	
00000000-0000-0000-0000-000000000000	bf3ec10d-7314-4e40-a1dc-d63cb75a7559	{"action":"token_revoked","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025-10-01 19:12:00.197097+00	
00000000-0000-0000-0000-000000000000	83bbc453-2529-4c20-84e1-9b9757eef747	{"action":"token_refreshed","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025-10-02 12:17:40.24545+00	
00000000-0000-0000-0000-000000000000	12c9d6a5-e376-4754-a9ea-47c8666bea84	{"action":"token_revoked","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025-10-02 12:17:40.260125+00	
00000000-0000-0000-0000-000000000000	69bfcc48-2e4c-4cfa-b480-e8a8d0e57ebf	{"action":"token_refreshed","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025-10-02 13:16:47.636269+00	
00000000-0000-0000-0000-000000000000	3ddc669d-92bf-4937-acce-16c60c91d198	{"action":"token_revoked","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025-10-02 13:16:47.643821+00	
00000000-0000-0000-0000-000000000000	a62fd300-601d-481f-9767-f624a83c2073	{"action":"token_refreshed","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025-10-02 14:15:35.717198+00	
00000000-0000-0000-0000-000000000000	e1692897-ef2f-4806-aa3f-6294012a50e4	{"action":"token_revoked","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025-10-02 14:15:35.728071+00	
00000000-0000-0000-0000-000000000000	cae03bf2-0aeb-479c-90c8-a913544d3980	{"action":"token_refreshed","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025-10-02 15:15:09.951123+00	
00000000-0000-0000-0000-000000000000	47811e91-bf7f-472f-b73b-f1a64059275f	{"action":"token_revoked","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025-10-02 15:15:09.963982+00	
00000000-0000-0000-0000-000000000000	9baee56c-dc46-4d00-b5a8-219ccab7d3e8	{"action":"token_refreshed","actor_id":"3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1","actor_username":"hosts@newrootsherbal.com","actor_via_sso":false,"log_type":"token"}	2025
a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	2025-09-22 17:21:38.061383+00	2025-11-11 17:43:49.861315+00	\N	aal1	\N	2025-11-11 17:43:49.861197	node	70.28.92.208	\N	\N	\N	\N
\.
...
91	22	\N	1	heading	{"level": 1, "textAlign": "center", "textColor": "primary", "text_content": "About Us: We are cool"}	0	2025-10-03 13:37:43.57698+00	2025-10-03 13:37:43.57698+00
92	22	\N	1	text	{"html_content": "<p>New text block...This Block Is Awesome!</p>"}	1	2025-10-03 13:37:43.57698+00	2025-10-03 13:37:43.57698+00
93	22	\N	1	image	{"width": 1024, "height": 1536, "caption": "", "alt_text": "ChatGPT Image of cartoon nick without bugs", "media_id": "45f2f6eb-8c1c-4da1-8549-2165b68be4cd", "object_key": "posts/quelque-chose-de-cool/chatgpt-image-apr-15-2025-10_27_32-am_20251002111706_original.avif", "blur_data_url": null}	2	2025-10-03 13:37:43.57698+00	2025-10-03 13:37:43.57698+00
...
94	22	\N	1	heading	{"level": 1, "textAlign": "left", "text_content": "Testing Revisions"}	3	2025-10-03 13:37:43.57698+00	2025-10-03 13:37:43.57698+00
95	22	\N	1	button	{"url": "#", "size": "default", "text": "Click Me For No Reason", "variant": "default"}	4	2025-10-03 13:37:43.57698+00	2025-10-03 13:37:43.57698+00
...
30	3	\N	1	section	{"padding": {"top": "md", "bottom": "md"}, "background": {"type": "gradient", "gradient": {"type": "linear", "stops": [{"color": "#2a476f", "position": 0}, {"color": "#1f96ad", "position": 100}], "direction": "to right"}}, "column_gap": "md", "column_blocks": [[{"content": {"width": 2560, "height": 2560, "caption": "", "alt_text": "0890 NRH Prostate Perform 60s EN (Bottle)", "media_id": "7171818b-7a7d-4ce4-8dcb-496a919c6a29", "object_key": "uploads/0890-nrh---prostate-perform-60s-en-bottle_20250602111225_original.avif", "blur_data_url": "data:image/png;base64,"}, "temp_id": "temp-1748446310608-0.9809145486622247", "block_type": "image"}], [{"content": {"level": 1, "textAlign": "center", "textColor": "background", "text_content": "This is awesomesss"}, "temp_id": "temp-1748446320489-0.03579022249796415", "block_type": "heading"}, {"content": {"html_content": "<style>\\n\\n.card-container {\\ndisplay: grid;\\ngrid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); /* Responsive part */\\ngap: 20px; /* Space between cards */\\n\\n}\\n\\n\\n\\n.card {\\nbackground-color: #fff;\\nborder: 1px solid #ddd;\\nborder-radius: 8px;\\noverflow: hidden; /* Ensures image corners are rounded if image is direct child */\\nbox-shadow: 0 2px 5px rgba(0,0,0,0.1);\\ndisplay: flex;\\nflex-direction: column;\\n\\n}\\n\\n\\n\\n.card img {\\nwidth: 100%;\\nheight: 200px; /* Fixed height for consistency */\\nobject-fit: cover; /* Ensures image covers the area without distortion */\\n\\n}\\n\\n\\n\\n.card-content {\\npadding: 15px;\\nflex-grow: 1; /* Allows content to take available space */\\ndisplay: flex;\\nflex-direction: column;\\n\\n}\\n\\n\\n\\n.card-content h3 {\\nmargin-top: 0;\\ncolor: #333;\\n\\n}\\n\\n\\n\\n.card-content p {\\nfont-size: 0.9em;\\ncolor: #666;\\nflex-grow: 1; /* Pushes button to the bottom */\\nline-height: 1.6;\\n\\n}\\n\\n\\n\\n.card-button {\\ndisplay: inline-block;\\nbackground-color: #007bff;\\ncolor: white;\\npadding: 10px 15px;\\ntext-decoration: none;\\nborder-radius: 5px;\\nmargin-top: 10px; /* Space above the button */\\ntext-align: center;\\ntransition: background-color 0.3s ease;\\n\\n}\\n\\n\\n\\n.card-button:hover {\\nbackground-color: #0056b3;\\n\\n}\\n\\n\\n\\n@media (max-width: 340px) {\\n.card-container {\\ngrid-template-columns: 1fr; /* Stack to single column */\\n}\\n\\n}\\n\\n</style><div class=\\"card-container\\"><div class=\\"card\\"><div class=\\"card-content\\"><h2>Card Title 1</h2><p></p><p>Read More</p></div></div><div class=\\"card\\"><div class=\\"card-content\\"><h2>Card Title 2</h2><p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p><p>Read More</p></div></div><div class=\\"card\\"><div class=\\"card-content\\"><h2>Card Title 3</h2><p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p><p>Read More</p></div></div></div><div></div>\\n\\n<div></div>\\n"}, "temp_id": "temp-1748461886858-0.7301177113712687", "block_type": "text"}]], "container_type": "container", "responsive_columns": {"mobile": 1, "tablet": 2, "desktop": 2}}	6	2025-05-28 15:32:09.062105+00	2025-10-30 18:47:29.923066+00
...
39	3	\N	1	hero	{"padding": {"top": "xl", "bottom": "xl"}, "background": {"type": "image", "image": {"size": "cover", "width": 1920, "height": 1080, "overlay": {"type": "gradient", "gradient": {"type": "linear", "stops": [{"color": "rgba(255, 255, 255, 0.1)", "position": 0}, {"color": "rgba(255, 255, 255, 0.4)", "position": 100}], "direction": "to bottom"}}, "media_id": "817f70a9-dc79-48e0-a319-0d595f177eef", "position": "top", "object_key": "pages/home/nrh-hero-image_7eb676be-02dd-4305-94b8-ac84c7391b28_20250613151919_original_20251030144834_xlarge_avif.avif"}, "min_height": "500px"}, "column_gap": "lg", "column_blocks": [[{"content": {"level": 1, "text_content": "Big Hero Title!"}, "temp_id": "block-1749744115796-1", "block_type": "heading"}, {"content": {"html_content": "<p>Hero description goes here. Explain the value proposition.</p>"}, "temp_id": "block-1749744115796-2", "block_type": "text"}, {"content": {"url": "#", "text": "Call to Action Now!!"}, "temp_id": "block-1749744115796-3", "block_type": "button"}], []], "container_type": "container", "responsive_columns": {"mobile": 1, "tablet": 1, "desktop": 2}}	0	2025-06-12 16:02:02.451919+00	2025-10-30 18:51:44.938515+00
...
33	3	\N	1	section	{"padding": {"top": "md", "bottom": "md"}, "background": {"type": "none"}, "column_gap": "md", "column_blocks": [[{"content": {"level": 1, "textAlign": "center", "textColor": "primary", "text_content": "Something Interesting"}, "temp_id": "temp-1748526644607-0.7296411873874854", "block_type": "heading"}, {"content": {"html_content": "<p>Something interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that <em><u>interesting </u></em>whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting.<br></p><div data-type=\\"danger\\" data-title=\\"Info Alert on this\\" data-message=\\"This test is not getting written?\\n\\" data-align=\\"center\\" data-size=\\"full-width\\" data-text-align=\\"left\\" data-alert-widget=\\"\\"></div><div data-text=\\"Click Here!!!\\" data-url=\\"#\\" data-style=\\"primary\\" data-size=\\"fit-content\\" data-text-align=\\"center\\" data-cta-widget=\\"\\"></div><p></p>"}, "block_type": "text"}, {"content": {"html_content": "<p>New text block...</p><p></p><div data-type=\\"info\\" data-title=\\"Info\\" data-message=\\"New Alert\\" data-align=\\"left\\" data-size=\\"fit-content\\" data-text-align=\\"left\\" data-alert-widget=\\"\\"></div><div></div>"}, "temp_id": "temp-1753373335816-0.33021135552657543", "block_type": "text"}], [{"content": {"width": 1024, "height": 585, "caption": "", "alt_text": "Tattoo ideas with cloud sword", "media_id": "ce2b77ad-f009-4ada-bed8-09301e6d26da", "object_key": "pages/home/kalitattoo_20251001140539_original.avif", "blur_data_url": null}, "temp_id": "temp-1748525825468-0.5679865408890822", "block_type": "image"}, {"content": {"html_content": "<h1 data-draggable=\\"true\\" style=\\"text-align: center;\\"><mark class=\\"rounded-sm px-1 py-0.5\\" data-color=\\"#D1FAE5\\" style=\\"background-color: rgb(209, 250, 229); color: inherit;\\">Testing</mark></h1><h3 data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing<sup>H3</sup></h3><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p><p data-draggable=\\"true\\" style=\\"text-align: right;\\">testing</p><pre class=\\"relative rounded-md bg-muted p-4 font-mono text-sm\\" data-draggable=\\"true\\"><code class=\\"language-plaintext\\">testing</code></pre><div data-text=\\"Learn more\\" data-url=\\"\\" data-style=\\"primary\\" data-size=\\"medium\\" data-text-align=\\"center\\" data-cta-widget=\\"\\"></div><p data-draggable=\\"true\\" style=\\"text-align: left;\\"><img class=\\"max-w-full h-auto rounded-md\\" data-draggable=\\"true\\" src=\\"https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/uploads/nextblock-logo_20250604160247_original.avif\\" alt=\\"nextblock-logo.png\\" data-lock-aspect=\\"true\\" data-align=\\"center\\" style=\\"width: 38.46%;\\"></p><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p>"}, "temp_id": "temp-1755096482986-0.4914380503781878", "block_type": "text"}]], "container_type": "container", "responsive_columns": {"mobile": 1, "tablet": 2, "desktop": 2}}	7	2025-05-29 13:37:29.308281+00	2025-10-30 18:47:51.961513+00
70	3	\N	1	text	{"html_content": "<style>.bold { font-weight: bold; }</style><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Wow this is cool</p></div><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p><div class=\\"bold\\"><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing</p><ul class=\\"list-disc pl-4\\" data-draggable=\\"true\\"><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">test</p></li><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">yes</p></li></ul></div><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></div><h1 data-draggable=\\"true\\" style=\\"text-align: left;\\">This is a <span style=\\"color: rgb(148, 0, 142);\\">title</span></h1><h2 data-draggable=\\"true\\" style=\\"text-align: left;\\"><span style=\\"color: rgb(119, 67, 196);\\">Testing</span></h2><ul class=\\"list-disc pl-4\\" data-draggable=\\"true\\"><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing</p></li><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">omg!</p></li></ul><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Something</p><pre class=\\"relative rounded-md bg-muted p-4 font-mono text-sm\\" data-draggable=\\"true\\"><code class=\\"language-plaintext\\">\\n\\nTesting\\n\\n&lt;h1&gt;is is another title&lt;/h1&gt; \\n\\n</code></pre><blockquote data-draggable=\\"true\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">This is a quote!</p></blockquote><table class=\\"w-full border-collapse border border-gray-300 dark:border-gray-700 my-4\\" style=\\"min-width: 300px;\\"><colgroup><col style=\\"min-width: 100px;\\"><col style=\\"min-width: 100px;\\"><col style=\\"min-width: 100px;\\"></colgroup><tbody><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Nice</p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Thanks</p></td></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td></tr></tbody></table><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p>"}	2	2025-08-15 15:49:00.235932+00	2025-11-03 18:42:58.03514+00
...
72	3	\N	1	image	{"width": 1920, "height": 1080, "caption": "", "alt_text": "Kali Wallpaper 2015 V1 1 0", "media_id": "63dccb09-f939-4a31-aba2-6eaaeb0ea51d", "object_key": "pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_original.avif", "blur_data_url": null}	3	2025-09-23 19:41:34.105526+00	2025-10-01 18:06:16.332463+00
75	\N	8	2	image	{"width": 1024, "height": 1536, "caption": "", "alt_text": "ChatGPT Image Apr 15, 2025, 10 27 32 AM", "media_id": "45f2f6eb-8c1c-4da1-8549-2165b68be4cd", "object_key": "posts/quelque-chose-de-cool/chatgpt-image-apr-15-2025-10_27_32-am_20251002111706_original.avif", "blur_data_url": null}	1	2025-10-02 15:16:51.620553+00	2025-10-02 15:17:33.988876+00
\.
...
COPY "public"."media" ("id", "uploader_id", "file_name", "object_key", "file_type", "size_bytes", "description", "created_at", "updated_at", "width", "height", "blur_data_url", "variants", "file_path", "folder") FROM stdin;
2ee9170c-9f10-494f-a33e-79f573d96a2a	\N	signature.jpg	uploads/signature_20250526111554.jpg	image/jpeg	27937	\N	2025-05-26 15:16:26.272731+00	2025-10-01 16:54:17.511821+00	384	96	\N	\N	\N	uploads/
cc6bc30c-0ebc-4d19-bef9-2d5a6936c180	\N	0pO7s4XqEjsIbJo7OMwDqxcOqZ78W190.webp	posts/two/0po7s4xqejsibjo7omwdqxcoqz78w190_20250526162504.webp	image/webp	34248	\N	2025-05-26 20:25:36.173219+00	2025-10-02 13:05:06.492888+00	2000	600	\N	[]	posts/two/0po7s4xqejsibjo7omwdqxcoqz78w190_20250526162504.webp	posts/two/
19752134-1dbe-4475-9ce3-103730029c65	\N	0KJJiCZvD1lr5OUrS359wZBCilteEuJ7.webp	posts/three/0kjjiczvd1lr5ours359wzbcilteeuj7_20250526162442.webp	image/webp	133358	\N	2025-05-26 20:25:14.776241+00	2025-10-02 13:05:16.041666+00	2000	600	\N	[]	posts/three/0kjjiczvd1lr5ours359wzbcilteeuj7_20250526162442.webp	posts/three/
ef642f5b-9391-4ea7-b72e-5c357edcc1a2	\N	nextblock-logo.png	logos/nextblock-logo_20250604160247_original.avif	image/avif	39591	\N	2025-06-04 20:03:38.819023+00	2025-10-01 19:29:27.215062+00	1162	1164	\N	[{"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/nextblock-logo_20250604160247.png", "width": 1162, "height": 1164, "fileType": "image/png", "objectKey": "logos/nextblock-logo_20250604160247.png", "sizeBytes": 111242, "variantLabel": "original_uploaded"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/nextblock-logo_20250604160247_xlarge_avif.avif", "width": 1162, "height": 1164, "fileType": "image/avif", "objectKey": "logos/nextblock-logo_20250604160247_xlarge_avif.avif", "sizeBytes": 36836, "variantLabel": "xlarge_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/nextblock-logo_20250604160247_large_avif.avif", "width": 1162, "height": 1164, "fileType": "image/avif", "objectKey": "logos/nextblock-logo_20250604160247_large_avif.avif", "sizeBytes": 36836, "variantLabel": "large_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/nextblock-logo_20250604160247_medium_avif.avif", "width": 768, "height": 769, "fileType": "image/avif", "objectKey": "logos/nextblock-logo_20250604160247_medium_avif.avif", "sizeBytes": 63228, "variantLabel": "medium_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/nextblock-logo_20250604160247_small_avif.avif", "width": 384, "height": 385, "fileType": "image/avif", "objectKey": "logos/nextblock-logo_20250604160247_small_avif.avif", "sizeBytes": 30711, "variantLabel": "small_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/nextblock-logo_20250604160247_thumbnail_avif.avif", "width": 128, "height": 128, "fileType": "image/avif", "objectKey": "logos/nextblock-logo_20250604160247_thumbnail_avif.avif", "sizeBytes": 8528, "variantLabel": "thumbnail_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/nextblock-logo_20250604160247_original.avif", "width": 1162, "height": 1164, "fileType": "image/avif", "objectKey": "logos/nextblock-logo_20250604160247_original.avif", "sizeBytes": 39591, "variantLabel": "original_avif"}]	logos/nextblock-logo_20250604160247_original.avif	logos/
b350eed1-adb6-4c8c-a1be-341e866f34d7	\N	0KJJiCZvD1lr5OUrS359wZBCilteEuJ7.webp	posts/two/0kjjiczvd1lr5ours359wzbcilteeuj7_20250527085100.webp	image/webp	133358	\N	2025-05-27 12:51:33.521431+00	2025-10-02 14:29:58.891742+00	2000	600	\N	[]	posts/two/0kjjiczvd1lr5ours359wzbcilteeuj7_20250527085100.webp	posts/two/
b214e748-1139-4608-a97e-62ce44edd6e4	\N	e0f51f6d-5ab5-4603-ba42-4b8dbcf2c6d2.webp	posts/this-is-a-very-long-post-name-to-fill-space/e0f51f6d-5ab5-4603-ba42-4b8dbcf2c6d2_20250529093721.webp	image/webp	415656	\N	2025-05-29 13:37:57.044539+00	2025-10-02 16:26:08.568441+00	1024	1024	\N	[]	posts/this-is-a-very-long-post-name-to-fill-space/e0f51f6d-5ab5-4603-ba42-4b8dbcf2c6d2_20250529093721.webp	posts/this-is-a-very-long-post-name-to-fill-space/
ff4767e9-3544-4579-b7d4-bc26cf985dad	\N	DALL·E 2024-07-03 11.00.24 - A representation of New Roots Herbal as a champion. The image features a large trophy with the New Roots Herbal logo on it, surrounded by vibrant and .webp	posts/this-is-another-full-long-stupidly-long-name-for-a-post/dalle-2024-07-03-11.00.24---a-representation-of-new-roots-herbal-as-a-champion.-the-image-features-a-large-trophy-with-the-new-roots-herbal-logo-on-it-surrounded-by-vibrant-and-_20250528103654.webp	image/webp	499302	\N	2025-05-28 14:37:28.489449+00	2025-10-02 16:26:34.201197+00	1024	1024	\N	[]	posts/this-is-another-full-long-stupidly-long-name-for-a-post/dalle-2024-07-03-11.00.24---a-representation-of-new-roots-herbal-as-a-champion.-the-image-features-a-large-trophy-with-the-new-roots-herbal-logo-on-it-surrounded-by-vibrant-and-_20250528103654.webp	posts/this-is-another-full-long-stupidly-long-name-for-a-post/
6fa3f17b-4da6-4dc3-8beb-5d27eb75a11b	\N	Trans-Logo.webp	logos/trans-logo_20250619101336_original.avif	image/avif	37246	\N	2025-06-19 14:13:58.521986+00	2025-10-01 19:26:52.548028+00	800	735	\N	[{"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/trans-logo_20250619101336.webp", "width": 800, "height": 735, "fileType": "image/webp", "objectKey": "logos/trans-logo_20250619101336.webp", "sizeBytes": 81914, "variantLabel": "original_uploaded"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/trans-logo_20250619101336_xlarge_avif.avif", "width": 800, "height": 735, "fileType": "image/avif", "objectKey": "logos/trans-logo_20250619101336_xlarge_avif.avif", "sizeBytes": 32416, "variantLabel": "xlarge_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/trans-logo_20250619101336_large_avif.avif", "width": 800, "height": 735, "fileType": "image/avif", "objectKey": "logos/trans-logo_20250619101336_large_avif.avif", "sizeBytes": 32416, "variantLabel": "large_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/trans-logo_20250619101336_medium_avif.avif", "width": 768, "height": 706, "fileType": "image/avif", "objectKey": "logos/trans-logo_20250619101336_medium_avif.avif", "sizeBytes": 29381, "variantLabel": "medium_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/trans-logo_20250619101336_small_avif.avif", "width": 384, "height": 353, "fileType": "image/avif", "objectKey": "logos/trans-logo_20250619101336_small_avif.avif", "sizeBytes": 16693, "variantLabel": "small_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/trans-logo_20250619101336_thumbnail_avif.avif", "width": 128, "height": 118, "fileType": "image/avif", "objectKey": "logos/trans-logo_20250619101336_thumbnail_avif.avif", "sizeBytes": 5707, "variantLabel": "thumbnail_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/trans-logo_20250619101336_original.avif", "width": 800, "height": 735, "fileType": "image/avif", "objectKey": "logos/trans-logo_20250619101336_original.avif", "sizeBytes": 37246, "variantLabel": "original_avif"}]	logos/trans-logo_20250619101336_original.avif	logos/
", "sizeBytes": 966598, "variantLabel": "original_uploaded"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/uploads/0890-nrh---prostate-perform-60s-en-bottle_20250602111225_xlarge_avif.avif", "width": 1920, "height": 1920, "fileType": "image/avif", "objectKey": "uploads/0890-nrh---prostate-perform-60s-en-bottle_20250602111225_xlarge_avif.avif", "sizeBytes": 80188, "variantLabel": "xlarge_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/uploads/0890-nrh---prostate-perform-60s-en-bottle_20250602111225_large_avif.avif", "width": 1280, "height": 1280, "fileType": "image/avif", "objectKey": "uploads/0890-nrh---prostate-perform-60s-en-bottle_20250602111225_large_avif.avif", "sizeBytes": 44204, "variantLabel": "large_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/uploads/0890-nrh---prostate-perform-60s-en-bottle_20250602111225_medium_avif.avif", "width": 768, "height": 768, "fileType": "image/avif", "objectKey": "uploads/0890-nrh---prostate-perform-60s-en-bottle_20250602111225_medium_avif.avif", "sizeBytes": 23049, "variantLabel": "medium_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/uploads/0890-nrh---prostate-perform-60s-en-bottle_20250602111225_small_avif.avif", "width": 384, "height": 384, "fileType": "image/avif", "objectKey": "uploads/0890-nrh---prostate-perform-60s-en-bottle_20250602111225_small_avif.avif", "sizeBytes": 10389, "variantLabel": "small_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/uploads/0890-nrh---prostate-perform-60s-en-bottle_20250602111225_thumbnail_avif.avif", "width": 128, "height": 128, "fileType": "image/avif", "objectKey": "uploads/0890-nrh---prostate-perform-60s-en-bottle_20250602111225_thumbnail_avif.avif", "sizeBytes": 2887, "variantLabel": "thumbnail_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/uploads/0890-nrh---prostate-perform-60s-en-bottle_20250602111225_original.avif", "width": 3000, "height": 3000, "fileType": "image/avif", "objectKey": "uploads/0890-nrh---prostate-perform-60s-en-bottle_20250602111225_original.avif", "sizeBytes": 365092, "variantLabel": "original_avif"}]	\N	uploads/
63dccb09-f939-4a31-aba2-6eaaeb0ea51d	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	kali-wallpaper-2015-v1-1-0.png	pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_original.avif	image/avif	28802	Kali Wallpaper 2015 V1 1 0	2025-10-01 18:06:11.75794+00	2025-10-01 19:06:40.905948+00	1920	1080	\N	[{"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/kali-wallpaper-2015-v1-1-0_20251001140555.png", "width": 1920, "height": 1080, "fileType": "image/png", "objectKey": "pages/home/kali-wallpaper-2015-v1-1-0_20251001140555.png", "sizeBytes": 1065522, "variantLabel": "original_uploaded"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_xlarge_avif.avif", "width": 1920, "height": 1080, "fileType": "image/avif", "objectKey": "pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_xlarge_avif.avif", "sizeBytes": 25910, "variantLabel": "xlarge_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_large_avif.avif", "width": 1280, "height": 720, "fileType": "image/avif", "objectKey": "pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_large_avif.avif", "sizeBytes": 17632, "variantLabel": "large_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_medium_avif.avif", "width": 768, "height": 432, "fileType": "image/avif", "objectKey": "pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_medium_avif.avif", "sizeBytes": 10357, "variantLabel": "medium_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_small_avif.avif", "width": 384, "height": 216, "fileType": "image/avif", "objectKey": "pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_small_avif.avif", "sizeBytes": 5183, "variantLabel": "small_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_thumbnail_avif.avif", "width": 128, "height": 72, "fileType": "image/avif", "objectKey": "pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_thumbnail_avif.avif", "sizeBytes": 1498, "variantLabel": "thumbnail_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_original.avif", "width": 1920, "height": 1080, "fileType": "image/avif", "objectKey": "pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_original.avif", "sizeBytes": 28802, "variantLabel": "original_avif"}]	pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_original.avif	pages/home/
ff3d2eb0-a3b0-475f-b855-2a1f6b4d6931	\N	NRH40EN.webp	logos/nrh40en_20250619113558_original.avif	image/avif	28756	\N	2025-06-19 15:36:11.394145+00	2025-10-01 19:26:50.088559+00	1000	371	\N	[{"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/nrh40en_20250619113558.webp", "width": 1000, "height": 371, "fileType": "image/webp", "objectKey": "logos/nrh40en_20250619113558.webp", "sizeBytes": 25692, "variantLabel": "original_uploaded"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/nrh40en_20250619113558_xlarge_avif.avif", "width": 1000, "height": 371, "fileType": "image/avif", "objectKey": "logos/nrh40en_20250619113558_xlarge_avif.avif", "sizeBytes": 26122, "variantLabel": "xlarge_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/nrh40en_20250619113558_large_avif.avif", "width": 1000, "height": 371, "fileType": "image/avif", "objectKey": "logos/nrh40en_20250619113558_large_avif.avif", "sizeBytes": 26122, "variantLabel": "large_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/nrh40en_20250619113558_medium_avif.avif", "width": 768, "height": 285, "fileType": "image/avif", "objectKey": "logos/nrh40en_20250619113558_medium_avif.avif", "sizeBytes": 24107, "variantLabel": "medium_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/nrh40en_20250619113558_small_avif.avif", "width": 384, "height": 142, "fileType": "image/avif", "objectKey": "logos/nrh40en_20250619113558_small_avif.avif", "sizeBytes": 14036, "variantLabel": "small_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/nrh40en_20250619113558_thumbnail_avif.avif", "width": 128, "height": 47, "fileType": "image/avif", "objectKey": "logos/nrh40en_20250619113558_thumbnail_avif.avif", "sizeBytes": 4264, "variantLabel": "thumbnail_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/logos/nrh40en_20250619113558_original.avif", "width": 1000, "height": 371, "fileType": "image/avif", "objectKey": "logos/nrh40en_20250619113558_original.avif", "sizeBytes": 28756, "variantLabel": "original_avif"}]	logos/nrh40en_20250619113558_original.avif	logos/
ce2b77ad-f009-4ada-bed8-09301e6d26da	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	Kali Tattoo	pages/home/kalitattoo_20251001140539_original.avif	image/avif	34287	Tattoo ideas with cloud sword	2025-10-01 18:05:53.276939+00	2025-10-02 14:49:46.067095+00	1024	585	\N	[{"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/kalitattoo_20251001140539.jpg", "width": 1024, "height": 585, "fileType": "image/jpeg", "objectKey": "pages/home/kalitattoo_20251001140539.jpg", "sizeBytes": 83149, "variantLabel": "original_uploaded"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/kalitattoo_20251001140539_xlarge_avif.avif", "width": 1024, "height": 585, "fileType": "image/avif", "objectKey": "pages/home/kalitattoo_20251001140539_xlarge_avif.avif", "sizeBytes": 31077, "variantLabel": "xlarge_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/kalitattoo_20251001140539_large_avif.avif", "width": 1024, "height": 585, "fileType": "image/avif", "objectKey": "pages/home/kalitattoo_20251001140539_large_avif.avif", "sizeBytes": 31077, "variantLabel": "large_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/kalitattoo_20251001140539_medium_avif.avif", "width": 768, "height": 439, "fileType": "image/avif", "objectKey": "pages/home/kalitattoo_20251001140539_medium_avif.avif", "sizeBytes": 20617, "variantLabel": "medium_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/kalitattoo_20251001140539_small_avif.avif", "width": 384, "height": 219, "fileType": "image/avif", "objectKey": "pages/home/kalitattoo_20251001140539_small_avif.avif", "sizeBytes": 7724, "variantLabel": "small_avif"}, {"url": "https://pub-a31e3f1a87d144898
_original_20251030144834_large_avif.avif", "sizeBytes": 191025, "variantLabel": "large_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/nrh-hero-image_7eb676be-02dd-4305-94b8-ac84c7391b28_20250613151919_original_20251030144834_medium_avif.avif", "width": 768, "height": 432, "fileType": "image/avif", "objectKey": "pages/home/nrh-hero-image_7eb676be-02dd-4305-94b8-ac84c7391b28_20250613151919_original_20251030144834_medium_avif.avif", "sizeBytes": 77760, "variantLabel": "medium_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/nrh-hero-image_7eb676be-02dd-4305-94b8-ac84c7391b28_20250613151919_original_20251030144834_small_avif.avif", "width": 384, "height": 216, "fileType": "image/avif", "objectKey": "pages/home/nrh-hero-image_7eb676be-02dd-4305-94b8-ac84c7391b28_20250613151919_original_20251030144834_small_avif.avif", "sizeBytes": 23110, "variantLabel": "small_avif"}, {"url": "https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/pages/home/nrh-hero-image_7eb676be-02dd-4305-94b8-ac84c7391b28_20250613151919_original_20251030144834_thumbnail_avif.avif", "width": 128, "height": 72, "fileType": "image/avif", "objectKey": "pages/home/nrh-hero-image_7eb676be-02dd-4305-94b8-ac84c7391b28_20250613151919_original_20251030144834_thumbnail_avif.avif", "sizeBytes": 4135, "variantLabel": "thumbnail_avif"}]	pages/home/nrh-hero-image_7eb676be-02dd-4305-94b8-ac84c7391b28_20250613151919_original_20251030144834_xlarge_avif.avif	pages/home/
\.
...
--
-- Data for Name: page_revisions; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY "public"."page_revisions" ("id", "page_id", "author_id", "version", "revision_type", "content", "created_at") FROM stdin;
1	22	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	2	snapshot	{"meta": {"slug": "about-us", "title": "About Us", "status": "published", "meta_title": "About Us", "language_id": 1, "meta_description": null}, "blocks": [{"order": 0, "content": {"level": 1, "textAlign": "center", "textColor": "primary", "text_content": "About Us: We are cool"}, "block_type": "heading", "language_id": 1}, {"order": 1, "content": {"html_content": "<p>New text block...This Block Is Awesome!</p>"}, "block_type": "text", "language_id": 1}, {"order": 2, "content": {"caption": "", "alt_text": "", "media_id": null}, "block_type": "image", "language_id": 1}, {"order": 3, "content": {"level": 1, "textAlign": "left", "text_content": "New Heading"}, "block_type": "heading", "language_id": 1}]}	2025-10-02 19:38:26.760948+00
2	22	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	3	diff	[{"op": "replace", "path": "/blocks/3/content/text_content", "value": "Testing Revisions"}]	2025-10-02 19:38:41.912809+00
7	22	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	4	diff	[{"op": "add", "path": "/blocks/4", "value": {"order": 4, "content": {"url": "#", "size": "default", "text": "Click Me", "variant": "default"}, "block_type": "button", "language_id": 1}}]	2025-10-02 19:53:45.809424+00
8	22	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	5	diff	[{"op": "replace", "path": "/blocks/4/content/text", "value": "Click Me For No Reason"}]	2025-10-02 19:54:00.902767+00
9	22	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	6	diff	[{"op": "replace", "path": "/blocks/2/content/media_id", "value": "45f2f6eb-8c1c-4da1-8549-2165b68be4cd"}, {"op": "replace", "path": "/blocks/2/content/alt_text", "value": "ChatGPT Image of cartoon nick without bugs"}, {"op": "add", "path": "/blocks/2/content/object_key", "value": "posts/quelque-chose-de-cool/chatgpt-image-apr-15-2025-10_27_32-am_20251002111706_original.avif"}, {"op": "add", "path": "/blocks/2/content/width", "value": 1024}, {"op": "add", "path": "/blocks/2/content/height", "value": 1536}, {"op": "add", "path": "/blocks/2/content/blur_data_url", "value": null}]	2025-10-03 13:22:31.965335+00
10	22	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	7	snapshot	{"meta": {"slug": "about-us", "title": "About Us", "status": "published", "meta_title": "About Us", "language_id": 1, "meta_description": null}, "blocks": [{"order": 0, "content": {"level": 1, "textAlign": "center", "textColor": "primary", "text_content": "About Us: We are cool"}, "block_type": "heading", "language_id": 1}, {"order": 1, "content": {"html_content": "<p>New text block...This Block Is Awesome!</p>"}, "block_type": "text", "language_id": 1}, {"order": 2, "content": {"caption": "", "alt_text": "", "media_id": null}, "block_type": "image", "language_id": 1}, {"order": 3, "content": {"level": 1, "textAlign": "left", "text_content": "New Heading"}, "block_type": "heading", "language_id": 1}]}	2025-10-03 13:37:11.709273+00
11	22	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	8	snapshot	{"meta": {"slug": "about-us", "title": "About Us", "status": "published", "meta_title": "About Us", "language_id": 1, "meta_description": null}, "blocks": [{"order": 0, "content": {"level": 1, "textAlign": "center", "textColor": "primary", "text_content": "About Us: We are cool"}, "block_type": "heading", "language_id": 1}, {"order": 1, "content": {"html_content": "<p>New text block...This Block Is Awesome!</p>"}, "block_type": "text", "language_id": 1}, {"order": 2, "content": {"width": 1024, "height": 1536, "caption": "", "alt_text": "ChatGPT Image of cartoon nick without bugs", "media_id": "45f2f6eb-8c1c-4da1-8549-2165b68be4cd", "object_key": "posts/quelque-chose-de-cool/chatgpt-image-apr-15-2025-10_27_32-am_20251002111706_original.avif", "blur_data_url": null}, "block_type": "image", "language_id": 1}, {"order": 3, "content": {"level": 1, "textAlign": "left", "text_content": "Testing Revisions"}, "block_type": "heading", "language_id": 1}, {"order": 4, "content": {"url": "#", "size": "default", "text": "Click Me For No Reason", "variant": "default"}, "block_type": "button", "language_id": 1}]}	2025-10-03 13:37:43.653094+00
12	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	2	snapshot	{"meta": {"slug": "home", "title": "Home", "status": "published", "meta_title": "Homepage", "language_id": 1, "meta_description": "This is the homepage."}, "blocks": [{"order": 0, "content": {"padding": {"top": "xl", "bottom": "xl"}, "background": {"type": "image", "image": {"size": "cover", "overlay": {"type": "gradient", "gradient": {"type": "linear", "stops": [{"color": "rgba(255, 255, 255, 1)", "position": 0}, {"color": "rgba(255, 255, 255, 0)", "position": 100}], "direction": "to right"}}, "media_id": "4bafbe01-d572-4da9-b866-352e2a36578e", "position": "center", "object_key": "uploads/nrh-hero-image_7eb676be-02dd-4305-94b8-ac84c7391b28_20250613151919_original.avif"}, "min_height": "500px"}, "column_gap": "lg", "column_blocks": [[{"content": {"level": 1, "text_content": "Big Hero Title!"}, "temp_id": "block-1749744115796-1", "block_type": "heading"}, {"content": {"html_content": "<p>Hero description goes here. Explain the value proposition.</p>"}, "temp_id": "block-1749744115796-2", "block_type": "text"}, {"content": {"url": "#", "text": "Call to Action Now!!"}, "temp_id": "block-1749744115796-3", "block_type": "button"}], []], "container_type": "container", "responsive_columns": {"mobile": 1, "tablet": 1, "desktop": 2}}, "block_type": "hero", "language_id": 1}, {"order": 1, "content": {"padding": {"top": "md", "bottom": "md"}, "background": {"type": "none"}, "column_gap": "md", "column_blocks": [[{"content": {"title": "Recent Posts", "columns": 4, "postsPerPage": 4, "showPagination": true}, "temp_id": "temp-1748449329438-0.04038678073462709", "block_type": "posts_grid"}]], "container_type": "container", "responsive_columns": {"mobile": 1, "tablet": 2, "desktop": 1}}, "block_type": "section", "language_id": 1}, {"order": 2, "content": {"html_content": "<style>.bold { font-weight: bold; }</style><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Wow this is cool</p></div><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"><span style=\\"font-size: 2.5rem; color: hsl(var(--destructive));\\">Something </span>really <sup>cool </sup>in a bold div</p></div><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing</p></div><h1 data-draggable=\\"true\\" style=\\"text-align: left;\\">This is a <span style=\\"color: rgb(148, 0, 142);\\">title</span></h1><h2 data-draggable=\\"true\\" style=\\"text-align: left;\\"><span style=\\"color: rgb(119, 67, 196);\\">Testing</span></h2><ul class=\\"list-disc pl-4\\" data-draggable=\\"true\\"><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing</p></li><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">omg!</p></li></ul><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Something</p><pre class=\\"relative rounded-md bg-muted p-4 font-mono text-sm\\" data-draggable=\\"true\\"><code class=\\"language-plaintext\\">\\n\\nTesting\\n\\n&lt;h1&gt;is is another title&lt;/h1&gt; \\n\\n</code></pre><blockquote data-draggable=\\"true\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">This is a quote!</p></blockquote><table class=\\"w-full border-collapse border border-gray-300 dark:border-gray-700 my-4\\" style=\\"min-width: 300px;\\"><colgroup><col style=\\"min-width: 100px;\\"><col style=\\"min-width: 100px;\\"><col style=\\"min-width: 100px;\\"></colgroup><tbody><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Nice</p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td></tr></tbody></table><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p>"}, "block_type": "text", "language_id": 1}, {"order": 3, "content": {"width": 1920, "height": 1080, "caption": "", "alt_text": "Kali Wallpaper 2015 V1 1 0", "media_id": "63dccb09-f939-4a31-aba2-6eaaeb0ea51d", "object_key": "pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_original.avif", "blur_data_url": null}, "block_type": "image", "language_id": 1}, {"order": 5, "content": {"padding": {"top": "md", "bottom": "md"}, "background": {"type": "none"}, "column_gap": "md", "column_blocks": [[{"content": {"level": 2, "textAlign": "center", "textColor": "primary", "text_content": "This is sub a title!"}, "temp_id": "temp-1748449263328-0.43594849790087153", "block_type": "heading"}], [{"content": {"html_content": "<p>New Column 2</p>"}, "temp_id": "new-1750176862087-0", "block_type": "text"}], [{"content": {"html_content": "<p>New Column 3</p>"}, "temp_id": "new-1750179380971-0", "block_type": "text"}]], "container_type": "container", "responsive_columns": {"mobile": 1, "tablet": 2, "desktop": 3}}, "block_type": "section", "language_id": 1}, {"order": 6, "content": {"padding": {"top": "md", "bottom": "md"}, "background": {"type": "gradient", "gradient": {"type": "linear", "stops": [{"color": "#2a476f", "position": 0}, {"color": "#1f96ad", "position": 100}], "direction": "to right"}}, "column_gap": "md", "column_blocks": [[{"content": {"width": 1080, "height": 1080, "caption": "", "alt_text": "Wild omega", "media_id": "d8f3b7eb-9357-4521-90fc-acc5449d59c0", "object_key": "uploads/vlcsnap-2023-01-11-10h44m50s203_20250722131944_original.avif", "blur_data_url": null}, "temp_id": "temp-1748446310608-0.9809145486622247", "block_type": "image"}], [{"content": {"level": 1, "textAlign": "center", "textColor": "background", "text_content": "This is awesomesss"}, "temp_id": "temp-1748446320489-0.03579022249796415", "block_type": "heading"}, {"content": {"html_content": "<style>\\n\\n.card-container {\\ndisplay: grid;\\ngrid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); /* Responsive part */\\ngap: 20px; /* Space between cards */\\n\\n}\\n\\n\\n\\n.card {\\nbackground-color: #fff;\\nborder: 1px solid #ddd;\\nborder-radius: 8px;\\noverflow: hidden; /* Ensures image corners are rounded if image is direct child */\\nbox-shadow: 0 2px 5px rgba(0,0,0,0.1);\\ndisplay: flex;\\nflex-direction: column;\\n\\n}\\n\\n\\n\\n.card img {\\nwidth: 100%;\\nheight: 200px; /* Fixed height for consistency */\\nobject-fit: cover; /* Ensures image covers the area without distortion */\\n\\n}\\n\\n\\n\\n.card-content {\\npadding: 15px;\\nflex-grow: 1; /* Allows content to take available space */\\ndisplay: flex;\\nflex-direction: column;\\n\\n}\\n\\n\\n\\n.card-content h3 {\\nmargin-top: 0;\\ncolor: #333;\\n\\n}\\n\\n\\n\\n.card-content p {\\nfont-size: 0.9em;\\ncolor: #666;\\nflex-grow: 1; /* Pushes button to the bottom */\\nline-height: 1.6;\\n\\n}\\n\\n\\n\\n.card-button {\\ndisplay: inline-block;\\nbackground-color: #007bff;\\ncolor: white;\\npadding: 10px 15px;\\ntext-decoration: none;\\nborder-radius: 5px;\\nmargin-top: 10px; /* Space above the button */\\ntext-align: center;\\ntransition: background-color 0.3s ease;\\n\\n}\\n\\n\\n\\n.card-button:hover {\\nbackground-color: #0056b3;\\n\\n}\\n\\n\\n\\n@media (max-width: 340px) {\\n.card-container {\\ngrid-template-columns: 1fr; /* Stack to single column */\\n}\\n\\n}\\n\\n</style><div class=\\"card-container\\"><div class=\\"card\\"><div class=\\"card-content\\"><h2>Card Title 1</h2><p></p><p>Read More</p></div></div><div class=\\"card\\"><div class=\\"card-content\\"><h2>Card Title 2</h2><p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p><p>Read More</p></div></div><div class=\\"card\\"><div class=\\"card-content\\"><h2>Card Title 3</h2><p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p><p>Read More</p></div></div></div><div></div>\\n\\n<div></div>\\n"}, "temp_id": "temp-1748461886858-0.7301177113712687", "block_type": "text"}]], "container_type": "container", "responsive_columns": {"mobile": 1, "tablet": 2, "desktop": 2}}, "block_type": "section", "language_id": 1}, {"order": 7, "content": {"padding": {"top": "md", "bottom": "md"}, "background": {"type": "none"}, "column_gap": "md", "column_blocks": [[{"content": {"level": 1, "textAlign": "center", "textColor": "primary", "text_content": "Something Interesting"}, "temp_id": "temp-1748526644607-0.7296411873874854", "block_type": "heading"}, {"content": {"html_content": "<p>Something interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that <em><u>interesting </u></em>whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting.<br></p><div data-type=\\"danger\\" data-title=\\"Info Alert on this\\" data-message=\\"This test is not getting written?\\n\\" data-align=\\"center\\" data-size=\\"full-width\\" data-text-align=\\"left\\" data-alert-widget=\\"\\"></div><div data-text=\\"Click Here!!!\\" data-url=\\"#\\" data-style=\\"primary\\" data-size=\\"fit-content\\" data-text-align=\\"center\\" data-cta-widget=\\"\\"></div><p></p>"}, "block_type": "text"}, {"content": {"html_content": "<p>New text block...</p><p></p><div data-type=\\"info\\" data-title=\\"Info\\" data-message=\\"New Alert\\" data-align=\\"left\\" data-size=\\"fit-content\\" data-text-align=\\"left\\" data-alert-widget=\\"\\"></div><div></div>"}, "temp_id": "temp-1753373335816-0.33021135552657543", "block_type": "text"}], [{"content": {"width": 1024, "height": 1024, "caption": "", "alt_text": "e0f51f6d-5ab5-4603-ba42-4b8dbcf2c6d2.webp", "media_id": "b214e748-1139-4608-a97e-62ce44edd6e4", "object_key": "uploads/e0f51f6d-5ab5-4603-ba42-4b8dbcf2c6d2_20250529093721.webp"}, "temp_id": "temp-1748525825468-0.5679865408890822", "block_type": "image"}, {"content": {"html_content": "<h1 data-draggable=\\"true\\" style=\\"text-align: center;\\"><mark class=\\"rounded-sm px-1 py-0.5\\" data-color=\\"#D1FAE5\\" style=\\"background-color: rgb(209, 250, 229); color: inherit;\\">Testing</mark></h1><h3 data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing<sup>H3</sup></h3><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p><p data-draggable=\\"true\\" style=\\"text-align: right;\\">testing</p><pre class=\\"relative rounded-md bg-muted p-4 font-mono text-sm\\" data-draggable=\\"true\\"><code class=\\"language-plaintext\\">testing</code></pre><div data-text=\\"Learn more\\" data-url=\\"\\" data-style=\\"primary\\" data-size=\\"medium\\" data-text-align=\\"center\\" data-cta-widget=\\"\\"></div><p data-draggable=\\"true\\" style=\\"text-align: left;\\"><img class=\\"max-w-full h-auto rounded-md\\" data-draggable=\\"true\\" src=\\"https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/uploads/nextblock-logo_20250604160247_original.avif\\" alt=\\"nextblock-logo.png\\" data-lock-aspect=\\"true\\" data-align=\\"center\\" style=\\"width: 38.46%;\\"></p><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p>"}, "temp_id": "temp-1755096482986-0.4914380503781878", "block_type": "text"}]], "container_type": "container", "responsive_columns": {"mobile": 1, "tablet": 2, "desktop": 2}}, "block_type": "section", "language_id": 1}]}	2025-10-06 13:49:00.504184+00
13	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	3	diff	[{"op": "replace", "path": "/blocks/2/content/html_content", "value": "<style>.bold { font-weight: bold; }</style><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Wow this is cool</p></div><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"><span style=\\"font-size: 2.5rem; color: hsl(var(--destructive));\\"><strong>Something </strong></span>really <sup>cool </sup>in a bold div</p></div><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing</p></div><h1 data-draggable=\\"true\\" style=\\"text-align: left;\\">This is a <span style=\\"color: rgb(148, 0, 142);\\">title</span></h1><h2 data-draggable=\\"true\\" style=\\"text-align: left;\\"><span style=\\"color: rgb(119, 67, 196);\\">Testing</span></h2><ul class=\\"list-disc pl-4\\" data-draggable=\\"true\\"><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing</p></li><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">omg!</p></li></ul><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Something</p><pre class=\\"relative rounded-md bg-muted p-4 font-mono text-sm\\" data-draggable=\\"true\\"><code class=\\"language-plaintext\\">\\n\\nTesting\\n\\n&lt;h1&gt;is is another title&lt;/h1&gt; \\n\\n</code></pre><blockquote data-draggable=\\"true\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">This is a quote!</p></blockquote><table class=\\"w-full border-collapse border border-gray-300 dark:border-gray-700 my-4\\" style=\\"min-width: 300px;\\"><colgroup><col style=\\"min-width: 100px;\\"><col style=\\"min-width: 100px;\\"><col style=\\"min-width: 100px;\\"></colgroup><tbody><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Nice</p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td></tr></tbody></table><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p>"}]	2025-10-10 18:48:44.281563+00
14	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	4	diff	[{"op": "replace", "path": "/blocks/2/content/html_content", "value": "<style>.bold { font-weight: bold; }</style><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Wow this is cool</p></div><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"><span style=\\"font-size: 2.5rem; color: hsl(var(--destructive));\\"><strong>Something </strong></span>really <sup>cool </sup>in a bold div</p></div><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing</p><ul class=\\"list-disc pl-4\\" data-draggable=\\"true\\"><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">test</p></li><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">yes</p></li></ul></div><h1 data-draggable=\\"true\\" style=\\"text-align: left;\\">This is a <span style=\\"color: rgb(148, 0, 142);\\">title</span></h1><h2 data-draggable=\\"true\\" style=\\"text-align: left;\\"><span style=\\"color: rgb(119, 67, 196);\\">Testing</span></h2><ul class=\\"list-disc pl-4\\" data-draggable=\\"true\\"><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing</p></li><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">omg!</p></li></ul><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Something</p><pre class=\\"relative rounded-md bg-muted p-4 font-mono text-sm\\" data-draggable=\\"true\\"><code class=\\"language-plaintext\\">\\n\\nTesting\\n\\n&lt;h1&gt;is is another title&lt;/h1&gt; \\n\\n</code></pre><blockquote data-draggable=\\"true\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">This is a quote!</p></blockquote><table class=\\"w-full border-collapse border border-gray-300 dark:border-gray-700 my-4\\" style=\\"min-width: 300px;\\"><colgroup><col style=\\"min-width: 100px;\\"><col style=\\"min-width: 100px;\\"><col style=\\"min-width: 100px;\\"></colgroup><tbody><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Nice</p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td></tr></tbody></table><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p>"}]	2025-10-29 14:52:11.725236+00
15	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	5	diff	[{"op": "remove", "path": "/blocks/0/content/background/min_height"}, {"op": "add", "path": "/blocks/0/content/background/image/width", "value": 1920}, {"op": "add", "path": "/blocks/0/content/background/image/height", "value": 1080}]	2025-10-30 18:42:11.03028+00
16	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	6	diff	[{"op": "add", "path": "/blocks/0/content/background/min_height", "value": "800px"}]	2025-10-30 18:44:46.223774+00
17	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	7	diff	[{"op": "replace", "path": "/blocks/0/content/background/min_height", "value": "500px"}]	2025-10-30 18:44:53.034153+00
18	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	8	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/position", "value": "bottom"}]	2025-10-30 18:44:58.43196+00
19	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	9	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/position", "value": "top"}]	2025-10-30 18:45:00.453354+00
20	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	10	diff	[{"op": "remove", "path": "/blocks/0/content/background/image/overlay"}]	2025-10-30 18:45:08.2567+00
21	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	11	diff	[{"op": "add", "path": "/blocks/0/content/background/image/overlay", "value": {"type": "gradient", "gradient": {"type": "linear", "stops": [{"color": "rgba(0,0,0,0.5)", "position": 0}, {"color": "rgba(0,0,0,0)", "position": 100}], "direction": "to bottom"}}}]	2025-10-30 18:45:10.329154+00
22	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	12	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/overlay/gradient/stops/0/color", "value": "rgba(255, 255, 255, 1)"}]	2025-10-30 18:45:18.955358+00
23	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	13	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/overlay/gradient/stops/0/color", "value": "rgba(255, 255, 255, 0)"}]	2025-10-30 18:45:24.354251+00
24	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	14	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/overlay/gradient/stops/0/color", "value": "rgba(255, 255, 255, 0.05)"}]	2025-10-30 18:45:28.43912+00
25	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	15	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/overlay/gradient/stops/0/color", "value": "rgba(255, 255, 255, 0.53)"}]	2025-10-30 18:45:29.708228+00
26	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	16	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/overlay/gradient/stops/0/color", "value": "rgba(255, 255, 255, 0.05)"}]	2025-10-30 18:45:30.888217+00
27	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	17	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/overlay/gradient/stops/0/color", "value": "rgba(255, 255, 255, 0)"}]	2025-10-30 18:45:32.022303+00
28	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	18	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/overlay/gradient/stops/0/color", "value": "rgba(255, 255, 255, 0.01)"}]	2025-10-30 18:45:33.008205+00
29	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	19	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/overlay/gradient/stops/0/color", "value": "rgba(255, 255, 255, 0.1)"}]	2025-10-30 18:45:34.005966+00
30	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	20	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/overlay/gradient/stops/1/color", "value": "rgba(255, 255, 255, 0)"}]	2025-10-30 18:45:41.589772+00
31	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	21	snapshot	{"meta": {"slug": "home", "title": "Home", "status": "published", "meta_title": "Homepage", "language_id": 1, "meta_description": "This is the homepage."}, "blocks": [{"order": 0, "content": {"padding": {"top": "xl", "bottom": "xl"}, "background": {"type": "image", "image": {"size": "cover", "width": 1920, "height": 1080, "overlay": {"type": "gradient", "gradient": {"type": "linear", "stops": [{"color": "rgba(255, 255, 255, 0.1)", "position": 0}, {"color": "rgba(201, 196, 196, 0)", "position": 100}], "direction": "to bottom"}}, "media_id": "4bafbe01-d572-4da9-b866-352e2a36578e", "position": "top", "object_key": "uploads/nrh-hero-image_7eb676be-02dd-4305-94b8-ac84c7391b28_20250613151919_original.avif"}, "min_height": "500px"}, "column_gap": "lg", "column_blocks": [[{"content": {"level": 1, "text_content": "Big Hero Title!"}, "temp_id": "block-1749744115796-1", "block_type": "heading"}, {"content": {"html_content": "<p>Hero description goes here. Explain the value proposition.</p>"}, "temp_id": "block-1749744115796-2", "block_type": "text"}, {"content": {"url": "#", "text": "Call to Action Now!!"}, "temp_id": "block-1749744115796-3", "block_type": "button"}], []], "container_type": "container", "responsive_columns": {"mobile": 1, "tablet": 1, "desktop": 2}}, "block_type": "hero", "language_id": 1}, {"order": 1, "content": {"padding": {"top": "md", "bottom": "md"}, "background": {"type": "none"}, "column_gap": "md", "column_blocks": [[{"content": {"title": "Recent Posts", "columns": 4, "postsPerPage": 4, "showPagination": true}, "temp_id": "temp-1748449329438-0.04038678073462709", "block_type": "posts_grid"}]], "container_type": "container", "responsive_columns": {"mobile": 1, "tablet": 2, "desktop": 1}}, "block_type": "section", "language_id": 1}, {"order": 2, "content": {"html_content": "<style>.bold { font-weight: bold; }</style><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Wow this is cool</p></div><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"><span style=\\"font-size: 2.5rem; color: hsl(var(--destructive));\\"><strong>Something </strong></span>really <sup>cool </sup>in a bold div</p></div><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing</p><ul class=\\"list-disc pl-4\\" data-draggable=\\"true\\"><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">test</p></li><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">yes</p></li></ul></div><h1 data-draggable=\\"true\\" style=\\"text-align: left;\\">This is a <span style=\\"color: rgb(148, 0, 142);\\">title</span></h1><h2 data-draggable=\\"true\\" style=\\"text-align: left;\\"><span style=\\"color: rgb(119, 67, 196);\\">Testing</span></h2><ul class=\\"list-disc pl-4\\" data-draggable=\\"true\\"><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing</p></li><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">omg!</p></li></ul><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Something</p><pre class=\\"relative rounded-md bg-muted p-4 font-mono text-sm\\" data-draggable=\\"true\\"><code class=\\"language-plaintext\\">\\n\\nTesting\\n\\n&lt;h1&gt;is is another title&lt;/h1&gt; \\n\\n</code></pre><blockquote data-draggable=\\"true\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">This is a quote!</p></blockquote><table class=\\"w-full border-collapse border border-gray-300 dark:border-gray-700 my-4\\" style=\\"min-width: 300px;\\"><colgroup><col style=\\"min-width: 100px;\\"><col style=\\"min-width: 100px;\\"><col style=\\"min-width: 100px;\\"></colgroup><tbody><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Nice</p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td></tr></tbody></table><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p>"}, "block_type": "text", "language_id": 1}, {"order": 3, "content": {"width": 1920, "height": 1080, "caption": "", "alt_text": "Kali Wallpaper 2015 V1 1 0", "media_id": "63dccb09-f939-4a31-aba2-6eaaeb0ea51d", "object_key": "pages/home/kali-wallpaper-2015-v1-1-0_20251001140555_original.avif", "blur_data_url": null}, "block_type": "image", "language_id": 1}, {"order": 5, "content": {"padding": {"top": "md", "bottom": "md"}, "background": {"type": "none"}, "column_gap": "md", "column_blocks": [[{"content": {"level": 2, "textAlign": "center", "textColor": "primary", "text_content": "This is sub a title!"}, "temp_id": "temp-1748449263328-0.43594849790087153", "block_type": "heading"}], [{"content": {"html_content": "<p>New Column 2</p>"}, "temp_id": "new-1750176862087-0", "block_type": "text"}], [{"content": {"html_content": "<p>New Column 3</p>"}, "temp_id": "new-1750179380971-0", "block_type": "text"}]], "container_type": "container", "responsive_columns": {"mobile": 1, "tablet": 2, "desktop": 3}}, "block_type": "section", "language_id": 1}, {"order": 6, "content": {"padding": {"top": "md", "bottom": "md"}, "background": {"type": "gradient", "gradient": {"type": "linear", "stops": [{"color": "#2a476f", "position": 0}, {"color": "#1f96ad", "position": 100}], "direction": "to right"}}, "column_gap": "md", "column_blocks": [[{"content": {"width": 1080, "height": 1080, "caption": "", "alt_text": "Wild omega", "media_id": "d8f3b7eb-9357-4521-90fc-acc5449d59c0", "object_key": "uploads/vlcsnap-2023-01-11-10h44m50s203_20250722131944_original.avif", "blur_data_url": null}, "temp_id": "temp-1748446310608-0.9809145486622247", "block_type": "image"}], [{"content": {"level": 1, "textAlign": "center", "textColor": "background", "text_content": "This is awesomesss"}, "temp_id": "temp-1748446320489-0.03579022249796415", "block_type": "heading"}, {"content": {"html_content": "<style>\\n\\n.card-container {\\ndisplay: grid;\\ngrid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); /* Responsive part */\\ngap: 20px; /* Space between cards */\\n\\n}\\n\\n\\n\\n.card {\\nbackground-color: #fff;\\nborder: 1px solid #ddd;\\nborder-radius: 8px;\\noverflow: hidden; /* Ensures image corners are rounded if image is direct child */\\nbox-shadow: 0 2px 5px rgba(0,0,0,0.1);\\ndisplay: flex;\\nflex-direction: column;\\n\\n}\\n\\n\\n\\n.card img {\\nwidth: 100%;\\nheight: 200px; /* Fixed height for consistency */\\nobject-fit: cover; /* Ensures image covers the area without distortion */\\n\\n}\\n\\n\\n\\n.card-content {\\npadding: 15px;\\nflex-grow: 1; /* Allows content to take available space */\\ndisplay: flex;\\nflex-direction: column;\\n\\n}\\n\\n\\n\\n.card-content h3 {\\nmargin-top: 0;\\ncolor: #333;\\n\\n}\\n\\n\\n\\n.card-content p {\\nfont-size: 0.9em;\\ncolor: #666;\\nflex-grow: 1; /* Pushes button to the bottom */\\nline-height: 1.6;\\n\\n}\\n\\n\\n\\n.card-button {\\ndisplay: inline-block;\\nbackground-color: #007bff;\\ncolor: white;\\npadding: 10px 15px;\\ntext-decoration: none;\\nborder-radius: 5px;\\nmargin-top: 10px; /* Space above the button */\\ntext-align: center;\\ntransition: background-color 0.3s ease;\\n\\n}\\n\\n\\n\\n.card-button:hover {\\nbackground-color: #0056b3;\\n\\n}\\n\\n\\n\\n@media (max-width: 340px) {\\n.card-container {\\ngrid-template-columns: 1fr; /* Stack to single column */\\n}\\n\\n}\\n\\n</style><div class=\\"card-container\\"><div class=\\"card\\"><div class=\\"card-content\\"><h2>Card Title 1</h2><p></p><p>Read More</p></div></div><div class=\\"card\\"><div class=\\"card-content\\"><h2>Card Title 2</h2><p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p><p>Read More</p></div></div><div class=\\"card\\"><div class=\\"card-content\\"><h2>Card Title 3</h2><p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p><p>Read More</p></div></div></div><div></div>\\n\\n<div></div>\\n"}, "temp_id": "temp-1748461886858-0.7301177113712687", "block_type": "text"}]], "container_type": "container", "responsive_columns": {"mobile": 1, "tablet": 2, "desktop": 2}}, "block_type": "section", "language_id": 1}, {"order": 7, "content": {"padding": {"top": "md", "bottom": "md"}, "background": {"type": "none"}, "column_gap": "md", "column_blocks": [[{"content": {"level": 1, "textAlign": "center", "textColor": "primary", "text_content": "Something Interesting"}, "temp_id": "temp-1748526644607-0.7296411873874854", "block_type": "heading"}, {"content": {"html_content": "<p>Something interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that <em><u>interesting </u></em>whenSomething interesting said to many times is not that interesting whenSomething interesting said to many times is not that interesting.<br></p><div data-type=\\"danger\\" data-title=\\"Info Alert on this\\" data-message=\\"This test is not getting written?\\n\\" data-align=\\"center\\" data-size=\\"full-width\\" data-text-align=\\"left\\" data-alert-widget=\\"\\"></div><div data-text=\\"Click Here!!!\\" data-url=\\"#\\" data-style=\\"primary\\" data-size=\\"fit-content\\" data-text-align=\\"center\\" data-cta-widget=\\"\\"></div><p></p>"}, "block_type": "text"}, {"content": {"html_content": "<p>New text block...</p><p></p><div data-type=\\"info\\" data-title=\\"Info\\" data-message=\\"New Alert\\" data-align=\\"left\\" data-size=\\"fit-content\\" data-text-align=\\"left\\" data-alert-widget=\\"\\"></div><div></div>"}, "temp_id": "temp-1753373335816-0.33021135552657543", "block_type": "text"}], [{"content": {"width": 1024, "height": 1024, "caption": "", "alt_text": "e0f51f6d-5ab5-4603-ba42-4b8dbcf2c6d2.webp", "media_id": "b214e748-1139-4608-a97e-62ce44edd6e4", "object_key": "uploads/e0f51f6d-5ab5-4603-ba42-4b8dbcf2c6d2_20250529093721.webp"}, "temp_id": "temp-1748525825468-0.5679865408890822", "block_type": "image"}, {"content": {"html_content": "<h1 data-draggable=\\"true\\" style=\\"text-align: center;\\"><mark class=\\"rounded-sm px-1 py-0.5\\" data-color=\\"#D1FAE5\\" style=\\"background-color: rgb(209, 250, 229); color: inherit;\\">Testing</mark></h1><h3 data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing<sup>H3</sup></h3><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p><p data-draggable=\\"true\\" style=\\"text-align: right;\\">testing</p><pre class=\\"relative rounded-md bg-muted p-4 font-mono text-sm\\" data-draggable=\\"true\\"><code class=\\"language-plaintext\\">testing</code></pre><div data-text=\\"Learn more\\" data-url=\\"\\" data-style=\\"primary\\" data-size=\\"medium\\" data-text-align=\\"center\\" data-cta-widget=\\"\\"></div><p data-draggable=\\"true\\" style=\\"text-align: left;\\"><img class=\\"max-w-full h-auto rounded-md\\" data-draggable=\\"true\\" src=\\"https://pub-a31e3f1a87d144898aeb489a8221f92e.r2.dev/uploads/nextblock-logo_20250604160247_original.avif\\" alt=\\"nextblock-logo.png\\" data-lock-aspect=\\"true\\" data-align=\\"center\\" style=\\"width: 38.46%;\\"></p><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p>"}, "temp_id": "temp-1755096482986-0.4914380503781878", "block_type": "text"}]], "container_type": "container", "responsive_columns": {"mobile": 1, "tablet": 2, "desktop": 2}}, "block_type": "section", "language_id": 1}]}	2025-10-30 18:45:42.527653+00
32	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	22	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/overlay/gradient/stops/1/color", "value": "rgba(255, 255, 255, 0)"}]	2025-10-30 18:45:43.539001+00
33	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	23	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/overlay/gradient/stops/1/color", "value": "rgba(255, 255, 255, 0.02)"}]	2025-10-30 18:45:45.975917+00
34	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	24	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/overlay/gradient/stops/1/color", "value": "rgba(255, 255, 255, 0.2)"}]	2025-10-30 18:45:47.121454+00
35	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	25	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/overlay/gradient/stops/1/color", "value": "rgba(255, 255, 255, 0)"}]	2025-10-30 18:45:52.558449+00
36	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	26	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/overlay/gradient/stops/1/color", "value": "rgba(255, 255, 255, 0.4)"}]	2025-10-30 18:45:53.492432+00
37	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	27	diff	[{"op": "replace", "path": "/blocks/5/content/column_blocks/0/0/content/blur_data_url", "value": "data:image/png;base64,"}, {"op": "replace", "path": "/blocks/5/content/column_blocks/0/0/content/object_key", "value": "uploads/0890-nrh---prostate-perform-60s-en-bottle_20250602111225_original.avif"}, {"op": "replace", "path": "/blocks/5/content/column_blocks/0/0/content/media_id", "value": "7171818b-7a7d-4ce4-8dcb-496a919c6a29"}, {"op": "replace", "path": "/blocks/5/content/column_blocks/0/0/content/alt_text", "value": "0890 NRH Prostate Perform 60s EN (Bottle)"}, {"op": "replace", "path": "/blocks/5/content/column_blocks/0/0/content/height", "value": 2560}, {"op": "replace", "path": "/blocks/5/content/column_blocks/0/0/content/width", "value": 2560}]	2025-10-30 18:47:30.296445+00
38	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	28	diff	[{"op": "replace", "path": "/blocks/6/content/column_blocks/1/0/content/object_key", "value": "pages/home/kalitattoo_20251001140539_original.avif"}, {"op": "replace", "path": "/blocks/6/content/column_blocks/1/0/content/media_id", "value": "ce2b77ad-f009-4ada-bed8-09301e6d26da"}, {"op": "replace", "path": "/blocks/6/content/column_blocks/1/0/content/alt_text", "value": "Tattoo ideas with cloud sword"}, {"op": "replace", "path": "/blocks/6/content/column_blocks/1/0/content/height", "value": 585}, {"op": "add", "path": "/blocks/6/content/column_blocks/1/0/content/blur_data_url", "value": null}]	2025-10-30 18:47:52.362611+00
39	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	29	diff	[{"op": "remove", "path": "/blocks/0/content/background/min_height"}, {"op": "replace", "path": "/blocks/0/content/background/image/object_key", "value": "pages/home/nrh-hero-image_7eb676be-02dd-4305-94b8-ac84c7391b28_20250613151919_original_20251030144834_xlarge_avif.avif"}, {"op": "replace", "path": "/blocks/0/content/background/image/media_id", "value": "817f70a9-dc79-48e0-a319-0d595f177eef"}]	2025-10-30 18:48:50.646881+00
40	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	30	diff	[{"op": "add", "path": "/blocks/0/content/background/min_height", "value": "500px"}]	2025-10-30 18:50:57.018006+00
41	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	31	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/position", "value": "center"}]	2025-10-30 18:51:17.719127+00
42	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	32	diff	[{"op": "replace", "path": "/blocks/0/content/background/image/position", "value": "top"}]	2025-10-30 18:51:45.245057+00
43	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	33	diff	[{"op": "replace", "path": "/blocks/2/content/html_content", "value": "<style>.bold { font-weight: bold; }</style><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Wow this is cool</p></div><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"><span style=\\"font-size: 2.5rem; color: hsl(var(--destructive));\\"><strong>Something </strong></span>really <sup>cool </sup>in a bold div</p></div><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing</p><ul class=\\"list-disc pl-4\\" data-draggable=\\"true\\"><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">test</p></li><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">yes</p></li></ul></div><h1 data-draggable=\\"true\\" style=\\"text-align: left;\\">This is a <span style=\\"color: rgb(148, 0, 142);\\">title</span></h1><h2 data-draggable=\\"true\\" style=\\"text-align: left;\\"><span style=\\"color: rgb(119, 67, 196);\\">Testing</span></h2><ul class=\\"list-disc pl-4\\" data-draggable=\\"true\\"><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing</p></li><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">omg!</p></li></ul><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Something</p><pre class=\\"relative rounded-md bg-muted p-4 font-mono text-sm\\" data-draggable=\\"true\\"><code class=\\"language-plaintext\\">\\n\\nTesting\\n\\n&lt;h1&gt;is is another title&lt;/h1&gt; \\n\\n</code></pre><blockquote data-draggable=\\"true\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">This is a quote!</p></blockquote><table class=\\"w-full border-collapse border border-gray-300 dark:border-gray-700 my-4\\" style=\\"min-width: 300px;\\"><colgroup><col style=\\"min-width: 100px;\\"><col style=\\"min-width: 100px;\\"><col style=\\"min-width: 100px;\\"></colgroup><tbody><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Nice</p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Thanks</p></td></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td></tr></tbody></table><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p>"}]	2025-11-03 14:39:56.626336+00
44	3	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	34	diff	[{"op": "replace", "path": "/blocks/2/content/html_content", "value": "<style>.bold { font-weight: bold; }</style><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Wow this is cool</p></div><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p><div class=\\"bold\\"><div class=\\"bold\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing</p><ul class=\\"list-disc pl-4\\" data-draggable=\\"true\\"><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">test</p></li><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">yes</p></li></ul></div><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></div><h1 data-draggable=\\"true\\" style=\\"text-align: left;\\">This is a <span style=\\"color: rgb(148, 0, 142);\\">title</span></h1><h2 data-draggable=\\"true\\" style=\\"text-align: left;\\"><span style=\\"color: rgb(119, 67, 196);\\">Testing</span></h2><ul class=\\"list-disc pl-4\\" data-draggable=\\"true\\"><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Testing</p></li><li><p data-draggable=\\"true\\" style=\\"text-align: left;\\">omg!</p></li></ul><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Something</p><pre class=\\"relative rounded-md bg-muted p-4 font-mono text-sm\\" data-draggable=\\"true\\"><code class=\\"language-plaintext\\">\\n\\nTesting\\n\\n&lt;h1&gt;is is another title&lt;/h1&gt; \\n\\n</code></pre><blockquote data-draggable=\\"true\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">This is a quote!</p></blockquote><table class=\\"w-full border-collapse border border-gray-300 dark:border-gray-700 my-4\\" style=\\"min-width: 300px;\\"><colgroup><col style=\\"min-width: 100px;\\"><col style=\\"min-width: 100px;\\"><col style=\\"min-width: 100px;\\"></colgroup><tbody><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th><th class=\\"bg-gray-100 dark:bg-gray-800 font-bold p-3 text-left border border-gray-300 dark:border-gray-700\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></th></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Nice</p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\">Thanks</p></td></tr><tr class=\\"border-b border-gray-300 dark:border-gray-700\\"><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td><td class=\\"p-3 border border-gray-300 dark:border-gray-700 min-w-[100px]\\" colspan=\\"1\\" rowspan=\\"1\\"><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p></td></tr></tbody></table><p data-draggable=\\"true\\" style=\\"text-align: left;\\"></p>"}]	2025-11-03 18:42:58.749902+00
\.
...
COPY "public"."pages" ("id", "language_id", "author_id", "title", "slug", "status", "meta_title", "meta_description", "created_at", "updated_at", "translation_group_id", "version") FROM stdin;
4	2	\N	Accueil	accueil	published	Page d'accueil	Ceci est la page d'accueil.	2025-05-21 14:43:10.491924+00	2025-07-17 16:55:21.642852+00	902b78c3-7270-4a8b-8466-3d6294f19351	1
5	1	\N	Blog	blog	published	Blog	Blog posts	2025-05-23 17:41:10.23302+00	2025-07-17 16:55:21.642852+00	c0b93c55-4ead-42e9-a8a0-4a51d703de97	1
6	2	\N	Blogue	blogue	published	Blogue	Articles de blogue	2025-05-23 17:41:10.371848+00	2025-07-17 16:55:21.642852+00	c0b93c55-4ead-42e9-a8a0-4a51d703de97	1
23	2	\N	A propos	a-propos	published	\N	\N	2025-07-03 17:27:15.766436+00	2025-07-17 16:55:21.642852+00	9fece45e-2ae1-43ae-b1b1-a5d5db659b10	1
24	1	\N	Contact Us	contact-us	published	\N	\N	2025-07-04 14:17:34.500236+00	2025-07-17 16:55:21.642852+00	a094ff1c-4956-42f0-9616-eb28dadf10d8	1
25	2	\N	Nous Joindre	nous-joindre	published	\N	\N	2025-07-04 14:17:57.994834+00	2025-07-17 16:55:21.642852+00	a094ff1c-4956-42f0-9616-eb28dadf10d8	1
22	1	\N	About Us	about-us	published	About Us	\N	2025-07-03 17:11:40.609609+00	2025-10-03 13:37:43.41316+00	9fece45e-2ae1-43ae-b1b1-a5d5db659b10	8
3	1	\N	Home	home	published	Homepage	This is the homepage.	2025-05-21 14:43:10.491924+00	2025-11-03 18:42:58.888838+00	902b78c3-7270-4a8b-8466-3d6294f19351	34
\.
...
COPY "public"."post_revisions" ("id", "post_id", "author_id", "version", "revision_type", "content", "created_at") FROM stdin;
1	7	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d1	2	snapshot	{"meta": {"slug": "something-cool", "title": "Something Cool", "status": "published", "excerpt": "cool", "meta_title": "cool", "language_id": 1, "published_at": "2025-07-21T16:27:00.000Z", "feature_image_id": "19752134-1dbe-4475-9ce3-103730029c65", "meta_description": "something cool"}, "blocks": [{"order": 0, "content": {"level": 1, "textAlign": "left", "textColor": "primary", "text_content": "New Heading"}, "block_type": "heading", "language_id": 1}]}	2025-10-03 14:11:34.843577+00
\.
...
COPY "public"."posts" ("id", "language_id", "author_id", "title", "slug", "excerpt", "status", "published_at", "meta_title", "meta_description", "created_at", "updated_at", "translation_group_id", "feature_image_id", "version") FROM stdin;
2	2	\N	Nouveau Post	nouveau-post	Placeholder for FR translation. Original excerpt: oh yes its working	published	2025-05-21 12:58:00+00	Nouveau	blog fr	2025-05-21 12:58:35.794324+00	2025-07-17 16:55:21.642852+00	002bd1e8-6594-4ed8-b2e4-2a3576856f4a	\N	1
1	1	\N	New Post	new-post	oh yes its working	published	2025-05-21 12:57:00+00	New Post	Testin for posts	2025-05-21 12:58:35.622789+00	2025-07-17 16:55:21.642852+00	002bd1e8-6594-4ed8-b2e4-2a3576856f4a	cc6bc30c-0ebc-4d19-bef9-2d5a6936c180	1
3	1	\N	First Post	first-post	This is the first cool post	published	2025-05-23 19:23:00+00	First Post	Blog post #1	2025-05-23 19:34:46.238064+00	2025-07-17 16:55:21.642852+00	76e278eb-5c1c-4f78-85b1-adb8ed0a4f75	b350eed1-adb6-4c8c-a1be-341e866f34d7	1
4	2	\N	[FR] First Post	first-post-fr-021081	Placeholder for FR translation. Original excerpt: This is the first cool post	published	\N	\N	\N	2025-05-23 19:34:46.386438+00	2025-07-17 16:55:21.642852+00	76e278eb-5c1c-4f78-85b1-adb8ed0a4f75	\N	1
5	1	\N	thrid post	thrid-post	yup	published	2025-05-29 14:17:00+00	\N	\N	2025-05-29 14:18:52.768271+00	2025-07-17 16:55:21.642852+00	a1be4f83-2db5-456b-8d21-c302ca15ad28	b214e748-1139-4608-a97e-62ce44edd6e4	1
6	2	\N	Troisieme post	troisieme-post	Placeholder for FR translation. Original excerpt: yup	published	\N	\N	\N	2025-05-29 14:18:52.944875+00	2025-07-17 16:55:21.642852+00	a1be4f83-2db5-456b-8d21-c302ca15ad28	\N	1
7	1	3a87caa1-8bd1-40d5-9328-7e1a7c4a31d
134	17445	Next.js Revalidate Pages	2025-11-03 14:39:56.750343+00	44
135	17445	Next.js Revalidate Pages	2025-11-03 18:42:58.888838+00	45
\.
...
20251001113000	{"-- Add a folder column to organize media by path prefix\nALTER TABLE public.media\nADD COLUMN IF NOT EXISTS folder TEXT","COMMENT ON COLUMN public.media.folder IS 'Folder path prefix for the R2 object (e.g., images/summer/).'","-- Backfill existing rows by deriving folder from object_key (everything up to last slash)\nUPDATE public.media\nSET folder = NULLIF(regexp_replace(object_key, '[^/]*$', ''), '')\nWHERE folder IS NULL","-- Index to speed up filtering by folder\nCREATE INDEX IF NOT EXISTS media_folder_idx ON public.media (folder)"}	add_folder_to_media
20250709120000	{"-- supabase/migrations/20250709120000_create_revisions_tables.sql\n-- Hybrid revision history for pages and posts\n\nbegin","-- Create enum for revision type if not exists\ndo $$\nbegin\n  if not exists (select 1 from pg_type where typname = 'revision_type') then\n    create type public.revision_type as enum ('snapshot', 'diff');\n  end if;\nend\n$$","-- Add version column to pages and posts if not exists\ndo $$\nbegin\n  if not exists (\n    select 1 from information_schema.columns\n    where table_schema = 'public' and table_name = 'pages' and column_name = 'version'\n  ) then\n    alter table public.pages add column version integer not null default 1;\n    comment on column public.pages.version is 'Monotonic version number for hybrid revisions.';\n  end if;\nend\n$$","do $$\nbegin\n  if not exists (\n    select 1 from information_schema.columns\n    where table_schema = 'public' and table_name = 'posts' and column_name = 'version'\n  ) then\n    alter table public.posts add column version integer not null default 1;\n    comment on column public.posts.version is 'Monotonic version number for hybrid revisions.';\n  end if;\nend\n$$","-- Create page_revisions table\ncreate table if not exists public.page_revisions (\n  id bigint generated by default as identity primary key,\n  page_id bigint not null references public.pages(id) on delete cascade,\n  author_id uuid references public.profiles(id) on delete set null,\n  version integer not null,\n  revision_type public.revision_type not null,\n  content jsonb not null,\n  created_at timestamp with time zone not null default now(),\n  constraint page_revisions_page_version_key unique (page_id, version)\n)","comment on table public.page_revisions is 'Hybrid (snapshot/diff) revisions for pages.'","comment on column public.page_revisions.content is 'If snapshot: full content; if diff: JSON Patch array.'","create index if not exists idx_page_revisions_page_id on public.page_revisions(page_id)","create index if not exists idx_page_revisions_page_id_version on public.page_revisions(page_id, version)","-- Create post_revisions table\ncreate table if not exists public.post_revisions (\n  id bigint generated by default as identity primary key,\n  post_id bigint not null references public.posts(id) on delete cascade,\n  author_id uuid references public.profiles(id) on delete set null,\n  version integer not null,\n  revision_type public.revision_type not null,\n  content jsonb not null,\n  created_at timestamp with time zone not null default now(),\n  constraint post_revisions_post_version_key unique (post_id, version)\n)","comment on table public.post_revisions is 'Hybrid (snapshot/diff) revisions for posts.'","comment on column public.post_revisions.content is 'If snapshot: full content; if diff: JSON Patch array.'","create index if not exists idx_post_revisions_post_id on public.post_revisions(post_id)","create index if not exists idx_post_revisions_post_id_version on public.post_revisions(post_id, version)","-- Enable RLS and add policies (admins and writers manage; authenticated can read)\nalter table public.page_revisions enable row level security","alter table public.post_revisions enable row level security","-- Page revisions policies\ndrop policy if exists \\"page_revisions_admin_writer_management\\" on public.page_revisions","create policy \\"page_revisions_admin_writer_management\\"\non public.page_revisions for all\nto authenticated\nusing (public.get_current_user_role() in ('ADMIN', 'WRITER'))\nwith check (public.get_current_user_role() in ('ADMIN', 'WRITER'))","drop policy if exists \\"page_revisions_authenticated_read\\" on public.page_revisions","create policy \\"page_revisions_authenticated_read\\"\non public.page_revisions for select\nto authenticated\nusing (true)","-- Post revisions policies\ndrop policy if exists \\"post_revisions_admin_writer_management\\" on public.post_revisions","create policy \\"post_revisions_admin_writer_management\\"\non public.post_revisions for all\nto authenticated\nusing (public.get_current_user_role() in ('ADMIN', 'WRITER'))\nwith check (public.get_current_user_role() in ('ADMIN', 'WRITER'))","drop policy if exists \\"post_revisions_authenticated_read\\" on public.post_revisions","create policy \\"post_revisions_authenticated_read\\"\non public.post_revisions for select\nto authenticated\nusing (true)",commit}	create_revisions_tables
\.
...
SELECT pg_catalog.setval('"public"."blocks_id_seq"', 95, true);
...
--
-- Name: page_revisions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('"public"."page_revisions_id_seq"', 44, true);
...
--
-- Name: post_revisions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('"public"."post_revisions_id_seq"', 1, true);
...
SELECT pg_catalog.setval('"supabase_functions"."hooks_id_seq"', 135, true);
...
--
-- Name: page_revisions page_revisions_page_version_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: post_revisions post_revisions_post_version_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_page_revisions_page_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_page_revisions_page_id_version; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "idx_page_revisions_page_id_version" ON "public"."page_revisions" USING "btree" ("page_id", "version");
...
--
-- Name: idx_post_revisions_post_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_post_revisions_post_id_version; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "idx_post_revisions_post_id_version" ON "public"."post_revisions" USING "btree" ("post_id", "version");
...
--
-- Name: page_revisions page_revisions_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: page_revisions page_revisions_admin_writer_management; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "page_revisions_admin_writer_management" ON "public"."page_revisions" TO "authenticated" USING (("public"."get_current_user_role"() = ANY (ARRAY['ADMIN'::"public"."user_role", 'WRITER'::"public"."user_role"]))) WITH CHECK (("public"."get_current_user_role"() = ANY (ARRAY['ADMIN'::"public"."user_role", 'WRITER'::"public"."user_role"])));


--
-- Name: page_revisions page_revisions_authenticated_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "page_revisions_authenticated_read" ON "public"."page_revisions" FOR SELECT TO "authenticated" USING (true);
...
--
-- Name: post_revisions; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."post_revisions" ENABLE ROW LEVEL SECURITY;

--
-- Name: post_revisions post_revisions_admin_writer_management; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "post_revisions_admin_writer_management" ON "public"."post_revisions" TO "authenticated" USING (("public"."get_current_user_role"() = ANY (ARRAY['ADMIN'::"public"."user_role", 'WRITER'::"public"."user_role"]))) WITH CHECK (("public"."get_current_user_role"() = ANY (ARRAY['ADMIN'::"public"."user_role", 'WRITER'::"public"."user_role"])));


--
-- Name: post_revisions post_revisions_authenticated_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "post_revisions_authenticated_read" ON "public"."post_revisions" FOR SELECT TO "authenticated" USING (true);
...
--
-- Name: SEQUENCE "page_revisions_id_seq"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "post_revisions"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE "post_revisions_id_seq"; Type: ACL; Schema: public; Owner: postgres
--
