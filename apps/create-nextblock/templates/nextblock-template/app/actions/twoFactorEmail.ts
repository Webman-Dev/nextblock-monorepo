...
export async function sendTwoFactorCodeEmail(
  ...
  await sendEmail({
    to,
    subject: 'Your NextBlock verification code',
    text: `Your NextBlock verification code is ${code}. It expires in 5 minutes. If you didn't request it, you can ignore this email.`,
    html: `
